                            ...
                            <div class="carousel-caption">
                                <div class="col-lg-12 text-center">
                                    <div class="section-heading">
                                        <h2>Log in</h2>
                                        <p class="text-muted">U moet inloggen voordat u de webshop kunt bezoeken</p>
                                        <hr>
                                    </div>
                                </div>
                                <form class="form-horizontal" action="inlogverwerking.php" method="post">
                                    <div class="form-group">
                                        <label class="control-label col-sm-2">Gebruikersnaam</label>
                                        <div class="col-sm-10">
                                            <input name="gebruikersnaam" type="text" class="form-control" placeholder="Voer gebruikersnaam in">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="control-label col-sm-2">Wachtwoord</label>
                                        <div class="col-sm-10">
                                            <input name="wachtwoord" type="password" class="form-control" placeholder="Voer wachtwoord in">
                                        </div>
                                    </div>
                                    <div class="form-group">
